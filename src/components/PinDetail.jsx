...
const PinDetail = ({ user }) => {
    ...
    return (
        <>
            ...
            >
                ...
                <div className="flex justify-center items-center md:items-start flex-initial ">
                    <img
                        ...
                        alt=""
                        className="rounded-t-3xl rounded-b-lg  xl:h-90vh "
                    />
                </div>
                ...
                <div className="w-full p-5 flex-1 xl:min-w-620">
                  ...
                  text-dark text-xl opacity-75 hover:opacity-100 hover:shadow-md outline-none"
                            >
                                <IoCloudDownload className="text-primary text-3xl  p-1 items-center" />
                            </a>
                        </div>
                        <a href={pinDetail.destination} target="_blank" rel="noreferrer" className="bg-white w-9 h-9  rounded-full flex items-center justify-center 
                  text-dark text-xl opacity-75 hover:opacity-100 hover:shadow-md outline-none" >
                            {/* {pinDetail.destination.length > 15
                                ? `${pinDetail.destination.slice(0, 15)}...`
                                : pinDetail.destination} */}

                            <AiFillInstagram size={30} className="text-primary  text-3xl rounded-md p-1 items-center" />
                        </a>
                    </div>
                    {/* pin title */}
                    <div>
                        <h1 className="text-4xl font-bold mt-3 break-words text-primary">
                            {pinDetail.title}
                        </h1>
                        <p className="mt-3 text-lightGray">{pinDetail.about}</p>
                    </div>
                    ...
                    <div className="flex flex-wrap items-center mt-6 gap-3">
                        ...
                        <input
                            type="text"
                            className="flex-1 border-pink-400 outline-none text-primary
             border-2 p-2 rounded-2xl focus:border-pink-600"
            ...
            {pins?.length > 0 ? (
                <>
                    <h2 className="text-center font-bold text-2xl mt-8 mb-4 text-primary">
                        More Like this
                    </h2>
